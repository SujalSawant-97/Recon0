   ...
   // private final OrganizationRepository organizationRepository;
    ...
    public AuthResponse registerUser(RegisterRequest registerRequest) {
       ...
       /* if ("organization".equalsIgnoreCase(savedUser.getRole())) {
        ...
        UserDto userDto = new UserDto(savedUser.getId(), savedUser.getDisplayName(), savedUser.getRole());
    ...
    public AuthResponse loginUser(LoginRequest loginRequest) {
        ...
        UserDto userDto = new UserDto(user.getId(), user.getDisplayName(), user.getRole());
